...
class ManagedObject(GLObject):
    ...
    @attention: When inheriting from L{BindableObject} and C{ManagedObject} at
    the same time, inherit from L{BindableObject} first to obtain the correct
    ordering for constructor calls.
